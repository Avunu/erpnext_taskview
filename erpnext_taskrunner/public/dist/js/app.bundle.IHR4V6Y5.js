...
(() => {
  ...
  // ../erpnext_taskrunner/node_modules/@vue/shared/dist/shared.esm-bundler.js
  ...
  // ../erpnext_taskrunner/node_modules/@vue/reactivity/dist/reactivity.esm-bundler.js
...
getter: `, this.getter);
  ...
  // ../erpnext_taskrunner/node_modules/@vue/runtime-core/dist/runtime-core.esm-bundler.js
  var stack = [];
...
Component that was made reactive: `,
  ...
  // ../erpnext_taskrunner/node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  // ../erpnext_taskrunner/node_modules/vue/dist/vue.runtime.esm-bundler.js
  function initDev() {
    {
      initCustomFormatter();
    }
  ...
  // ../erpnext_taskrunner/node_modules/vue-demi/lib/index.mjs
  var isVue2 = false;
  var isVue3 = true;

  // ../erpnext_taskrunner/node_modules/@babel/runtime/helpers/esm/typeof.js
  function _typeof(o) {
  ...
  // ../erpnext_taskrunner/node_modules/@babel/runtime/helpers/esm/toPrimitive.js
  ...
  // ../erpnext_taskrunner/node_modules/@babel/runtime/helpers/esm/toPropertyKey.js
  function toPropertyKey(t) {
    var i = toPrimitive(t, "string");
    return "symbol" == _typeof(i) ? i : i + "";
  }

  // ../erpnext_taskrunner/node_modules/@babel/runtime/helpers/esm/defineProperty.js
  ...
  // ../erpnext_taskrunner/node_modules/helper-js/dist/index.esm.js
  function isArray2(v) {
  ...
  // ../erpnext_taskrunner/node_modules/@virtual-list/vue/dist/v3/index.es.js
  ...
  // ../erpnext_taskrunner/node_modules/@he-tree/tree-utils/dist/index.esm.js
  ...
  // ../erpnext_taskrunner/node_modules/drag-event-service/dist/index.esm.js
  var events = {
  ...
  // ../erpnext_taskrunner/node_modules/@he-tree/dnd-utils/dist/index.esm.js
  ...
  // ../erpnext_taskrunner/node_modules/@he-tree/vue/dist/v3/index.es.js
  ...
  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/assets/js/script.js
  ...
  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/assets/js/task.js
  function useTask(props, emit2, isEditing, editedText, cancelTriggered) {
    ...
    const updateTimesheetDetail = async (projectName, taskName, status, timesheetDetail, description = "") => {
      if (!timesheetDetail) {
        timesheetDetail = {};
      }
      try {
        const r = await callBackendHandler("toggle_timer", { project: projectName, docName: taskName, status, timesheetDetail, description }, null);
        return r.message;
      } catch (error) {
        emit2("catch-error", error);
      }
  ...
  // sfc-script:/var/www/erp.avu.nu/html/apps/erpnext_taskrunner/erpnext_taskrunner/public/js/components/Task.vue?type=script
  ...
  // sfc-template:/var/www/erp.avu.nu/html/apps/erpnext_taskrunner/erpnext_taskrunner/public/js/components/Task.vue?type=template
  var _withScopeId = (n) => (pushScopeId("data-v-ac1e717b"), n = n(), popScopeId(), n);
  ...
  var _hoisted_5 = { class: "expand-sidebar-container" };
  var _hoisted_6 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "expand-icon" }, "\u2922", -1));
  var _hoisted_7 = [
    _hoisted_6
  ];
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", _hoisted_13, [
        ...
        !_ctx.doc.isBlank ? (openBlock(), createElementBlock("div", _hoisted_23, [
        ...
        createBaseVNode("div", _hoisted_5, [
          !_ctx.doc.isBlank ? (openBlock(), createElementBlock("button", {
            ...
            onClick: _cache[1] || (_cache[1] = (...args) => _ctx.emitSidebar && _ctx.emitSidebar(...args))
  ...
  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/components/Task.vue
  Task_default.render = render;
  Task_default.__file = "../erpnext_taskrunner/erpnext_taskrunner/public/js/components/Task.vue";
  Task_default.__scopeId = "data-v-ac1e717b";
  var Task_default2 = Task_default;

  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/assets/js/taskrunner.js
  function useTaskRunner(props, treeData, highlightedProject, dragContext, currentTheme, isOpened, formWrapper, showForm, timeLoggerDoc, descriptionOnly) {
    ...
    const openSidebar = (doc2) => {
      ...
      if (Object.hasOwn(doc2, "isProject")) {
        ...
        if (doc2.status && doc2.status === "stopped") {
  ...
  // ../erpnext_taskrunner/node_modules/body-scroll-lock/lib/bodyScrollLock.esm.js
  ...
  // ../erpnext_taskrunner/node_modules/vue3-side-panel/dist/vue3-side-panel.esm.js
  var script$1 = defineComponent({
    name: "SidePanelCloseButton",
    emits: ["close"]
  });
  var _hoisted_14 = /* @__PURE__ */ createBaseVNode("span", { class: "vsp-close__x" }, null, -1);
  var _hoisted_24 = [
    _hoisted_14
  ];
  ...
  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/assets/js/timelogger.js
  ...
  // sfc-script:/var/www/erp.avu.nu/html/apps/erpnext_taskrunner/erpnext_taskrunner/public/js/components/TimeLogger.vue?type=script
  ...
  // sfc-template:/var/www/erp.avu.nu/html/apps/erpnext_taskrunner/erpnext_taskrunner/public/js/components/TimeLogger.vue?type=template
  var _hoisted_15 = ["data-theme"];
  var _hoisted_25 = /* @__PURE__ */ createBaseVNode("label", { for: "description" }, "Description:", -1);
  var _hoisted_33 = {
    key: 0,
    class: "datetime-pickers"
  };
  var _hoisted_42 = /* @__PURE__ */ createBaseVNode("label", { for: "start-time" }, "Start Time:", -1);
  var _hoisted_52 = /* @__PURE__ */ createBaseVNode("label", { for: "stop-time" }, "Stop Time:", -1);
  var _hoisted_62 = { class: "button-group" };
  var _hoisted_72 = /* @__PURE__ */ createBaseVNode("button", {
    type: "submit",
    id: "log-button"
  }, "Log", -1);
  function render3(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", {
      class: "sidebar-content time-logger-sidebar",
      "data-theme": _ctx.currentTheme
    }, [
      createBaseVNode("h3", null, toDisplayString(_ctx.descriptionOnly ? "Add Description" : "Log time for " + _ctx.docText), 1),
      createBaseVNode("form", {
        ...
        createCommentVNode(" Conditionally show the datetime pickers "),
        !_ctx.descriptionOnly ? (openBlock(), createElementBlock("div", _hoisted_33, [
          _hoisted_42,
        ...
        createBaseVNode("div", _hoisted_62, [
          _hoisted_72,
          !_ctx.descriptionOnly ? (openBlock(), createElementBlock("button", {
            key: 0,
            type: "button",
            id: "cancel-button",
            onClick: _cache[3] || (_cache[3] = (...args) => _ctx.closeSidebar && _ctx.closeSidebar(...args))
          }, "Cancel")) : createCommentVNode("v-if", true)
        ])
      ], 32)
    ], 8, _hoisted_15);
  }

  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/components/TimeLogger.vue
  TimeLogger_default.render = render3;
  TimeLogger_default.__file = "../erpnext_taskrunner/erpnext_taskrunner/public/js/components/TimeLogger.vue";
  var TimeLogger_default2 = TimeLogger_default;

  // sfc-script:/var/www/erp.avu.nu/html/apps/erpnext_taskrunner/erpnext_taskrunner/public/js/TaskRunner.vue?type=script
  var TaskRunner_default = defineComponent({
    name: "TaskRunner",
    components: {
      Draggable: cpt2,
      OpenIcon,
    ...
    setup(props) {
      ...
      const {
        ...
        openSidebar,
        closeTimeLogger
      } = useTaskRunner(props, treeData, highlightedProject, context2, currentTheme, isOpened, formWrapper, showForm, timeLoggerDoc, descriptionOnly);
      premount();
      onMounted(() => {
        useOnMounted();
      });
  ...
  // sfc-template:/var/www/erp.avu.nu/html/apps/erpnext_taskrunner/erpnext_taskrunner/public/js/TaskRunner.vue?type=template
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_53, [
              ...
              !_ctx.showForm ? (openBlock(), createBlock(_component_TimeLogger, {
                ...
                isOpened: _ctx.isOpened,
                descriptionOnly: _ctx.descriptionOnly,
                onCloseTimeLogger: _ctx.closeTimeLogger
              }, null, 8, ["doc", "currentTheme", "isOpened", "descriptionOnly", "onCloseTimeLogger"])) : createCommentVNode("v-if", true)
            ])
          ]),
          _: 1
        }, 8, ["modelValue"])
  ...
  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/TaskRunner.vue
  TaskRunner_default.render = render4;
  TaskRunner_default.__file = "../erpnext_taskrunner/erpnext_taskrunner/public/js/TaskRunner.vue";
  var TaskRunner_default2 = TaskRunner_default;

  // ../erpnext_taskrunner/erpnext_taskrunner/public/js/app.bundle.js
  ...
  frappe.views.TasksView = class TasksView extends frappe.views.ListView {
    ...
    render_list() {
      ...
      locals.nodes = {};
      createApp({
        render: () => h(TaskRunner_default2, { docs: this.data })
      }).mount(container);
    }
  };
